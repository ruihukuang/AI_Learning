...
Unanswerable questions that will be sent to an app in Pushover on my phone from a locally built chat box  
<img width="998" height="509" alt="image" src="https://github.com/user-attachments/assets/fad35308-a4bf-4208-9268-7d252b611c20" />   
User contact details that will be sent to an app in Pushover on my phone from a locally built chat box   
